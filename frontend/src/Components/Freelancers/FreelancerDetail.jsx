...
const FreelancerDetail = () => {
  ...
  if (portfolio !== undefined) {
    console.log(portfolio.data.attributes);
              ...
              <div className="col-lg-4 col-md-12 col-sm-12">
                ...
                <div className="_jb_summary light_box p-4">
                  ...
                  <ul>
                    ...
                    <li>
                      Rate:<span>${portfolio.data.attributes.rate} hourly</span>
                    </li>
                    <li>
                      Hours:<span>{portfolio.data.attributes.hour}h/week</span>
                    </li>
                    <li>
                      Disability percent:{" "}
                      <span>
                        {portfolio.data.attributes.disabilityPercent}%
                      </span>
                    </li>
                  </ul>
                </div>
