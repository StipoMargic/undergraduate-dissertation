...
class Job implements EntityInterface
{
    ...
    /** @ORM\Column(name="job_duties", type="text", nullable=false) */
    private string $jobDuties;

    /** @ORM\Column(name="job_duties_bulletins", type="text", nullable=false) */
    ...
    /** @ORM\Column(name="job_summary", nullable=false, type="text") */
    ...
    {
        $this->removeFromApplied($applicantName);
    ...
    public function removeFromApplied(string $applicantName): void
    {
